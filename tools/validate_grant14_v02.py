"""Exhaustive independent validator for SHADOW SUM GRANT14 v0.2."""
import itertools
import json
from pathlib import Path

DATA = Path(__file__).resolve().parents[1] / "data/grant14_v0_2.json"
...
def validate():
    ...
    assert [s["id"] for s in stages] == [f"GR{i:02}" for i in range(1, 15)]
